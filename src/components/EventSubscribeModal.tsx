...
import { X, Search, Globe, Lock, CheckCircle, Clock, AlertCircle, Link2 } from 'lucide-react';
                  ...
                  {loading ? (
                    ...
                    filteredEvents.map((event) => (
                      <button
                        ...
                        className="flex items-center justify-between p-4 rounded-xl border border-[var(--border-default)] hover:border-primary/50 hover:bg-primary/5 transition-all text-left group"
                      >
                        <div className="flex items-center gap-3">
              ...
              <div className="p-4 bg-primary/5 rounded-xl border border-primary/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h4 className="text-md font-bold text-[var(--text-primary)]">
                      {availableEvents.find(e => e.id === selectedContractId)?.eventName}
                    </h4>
                  </div>
                </div>
                <button
